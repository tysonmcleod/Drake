...
function listCreate(parent_list_id,food_info){
	var list = document.createElement("LI");
	var foodInfo_text = document.createTextNode(food_info);
	list.appendChild(foodInfo_text);
	document.getElementById(parent_list_id).appendChild(list);
}
	/* "refresh" the page*/
function refresh(){
